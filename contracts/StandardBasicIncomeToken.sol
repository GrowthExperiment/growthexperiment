 ...
 */
contract StandardBasicIncomeToken is ERC20, BasicIncomeToken {
  ...
  function transferFrom(address _from, address _to, uint256 _value) public returns (bool) {
    ...
    int256 new_balance = balances[_from] - int256(_value);
    require(new_balance <= balances[_from]);
    balances[_from] = new_balance;
